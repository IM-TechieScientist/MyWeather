      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text(_weather?.cityName ?? "locating city",style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 32.0,color: Colors.white),),
                ],
              ),
            ),
            ...
            Text('${_weather?.temperature.round()}°C',style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 48,color: Colors.white),),
          ],
        ),
      ),
    );
